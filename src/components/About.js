        ...
        <div className="container" style={{color: props.mode === 'dark'? 'white':'black', backgroundColor: props.mode === 'dark'? 'black':'white'}}>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" style={{color: props.mode === 'dark'? 'white':'black', backgroundColor: props.mode === 'dark'? 'black':'white'}} aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseTwo" className="accordion-collapse collapse" style={{color: props.mode === 'dark'? 'white':'black', backgroundColor: props.mode === 'dark'? 'black':'white'}} aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" style={{color: props.mode === 'dark'? 'white':'black', backgroundColor: props.mode === 'dark'? 'black':'white'}} aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
